                          ...
                          <Container className= {classes.mobLevels}>
                            <Box className= {classes.mobSection1}>
                                ...
                                <Container className= {classes.mobSection2}>
                                      <Typography className= {classes.mobHeader}>4x4</Typography>
                                      <br/>
                                ...
                                <Container className= {classes.mobGrid}>
                                  ...
                                  <Container className= {classes.mobSection2}>
                                      <Typography className= {classes.mobHeader}>6x6</Typography>
                                      <br/>
                                  ...
                                  <Container className= {classes.mobSection2}>
                                      <Typography className= {classes.mobHeader}>9x9</Typography>
                                      <br/>
