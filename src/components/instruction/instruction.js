...
function Instruction () {
    ...
    return (
        <div>
            ...
            <p onClick={goBack} className='cancel'> X </p>
            ...
            <section>
                <div>
                    ...
                    <p className='bot'> Each row, column and square needs to be filled out with the numbers 1-6, without repeating any numbers within the row, column or square.</p>          
                </div>

                <div>
                    <h5 className="top"> Instructions: </h5>
                    <p className='bottom'> 1. In the light blue box enter the number 6. </p>
                    <p className='bottom'> 2. In the next light blue box enter the number 5. </p>
                </div>
